...
import UrlHelper from "../../utils/helper";
                        ...
                        <div className="card-body">
                            ...
                            <form id="form-login" onSubmit={e => this.handleSubmitLogin(e)}>
                                <div className="mb-3">
                                    ...
                                    <input type="email" id="auth-email" name="email" className="form-control" placeholder="your@email.com" />
                                </div>
                                <div className="form-footer">
                                    <button type="submit" className={`btn btn-primary w-100 ${this.state.isSearchingCredential ? 'disabled' : ''}`}>{this.state.isSearchingCredential ? 'Processing...' : 'Sign in'}</button>
                                </div>
                            </form>
                        </div>
